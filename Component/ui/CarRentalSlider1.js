...
const Slider2 = () => {
  ...
  return (
    <>
      <div className="z-10 ">
        <Slider {...setting}>
          <div className="w-full  CarRental_bg relative mt-10 ml-0  bg-right bg-cover bg-no-repeat ">
            <div className="  p-64 ">
          ...
          <div className="w-full  CarRental_bg relative mt-10 ml-0  bg-right bg-cover font-Segoe bg-no-repeat">
            <div className=" p-64  ">
              <div className="w-24 mt-[-20%] ml-[-10%] ">
                <Image
                  src="/Images/Frame.svg"
